...
import FormatSQL from "services/FormatSQL.service";
...
const StoreProcedure = () => {
    ...
    const [generateType, setGenerateType] = useState(GENERATE_OPTIONS.DELETE);

    useEffect(() => {
        document.title = "Store procedures";
    });
                    ...
                    >
                        <Dropdown.Button
                            ...
                            menu={{
                                ...
                                onClick: (e) => {
                                    if (e.key == 1) {
                                        FormatSQL(result, "Collapsed").then(
                                            (res) => {
                                                if (res.status) {
                                                    setResult(res.data);
                                                } else {
                                        ...
                                        FormatSQL(result, "Indented").then(
                                            (res) => {
                                                if (res.status) {
                                                    setResult(res.data);
                                                } else {
